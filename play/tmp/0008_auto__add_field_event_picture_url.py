...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.picture_url'
        db.add_column(u'play_event', 'picture_url',
                      self.gf('django.db.models.fields.CharField')(default='/static/img/avatar-1.png', max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.picture_url'
        db.delete_column(u'play_event', 'picture_url')
