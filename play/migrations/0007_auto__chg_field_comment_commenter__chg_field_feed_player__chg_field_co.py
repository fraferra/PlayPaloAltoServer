...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'play_comment', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['play.Player']))

        # Changing field 'Feed.player'
        db.alter_column(u'play_feed', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['play.Player']))

        # Changing field 'CommentFeed.commenter'
        db.alter_column(u'play_commentfeed', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['play.Player']))

    def backwards(self, orm):

        # Changing field 'Comment.commenter'
        db.alter_column(u'play_comment', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Feed.player'
        db.alter_column(u'play_feed', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'CommentFeed.commenter'
        db.alter_column(u'play_commentfeed', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'play.comment': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['play.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'play.commentfeed': {
