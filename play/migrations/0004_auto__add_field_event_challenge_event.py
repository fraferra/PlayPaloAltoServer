...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.challenge_event'
        db.add_column(u'play_event', 'challenge_event',
                      self.gf('django.db.models.fields.CharField')(default='Event', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.challenge_event'
        db.delete_column(u'play_event', 'challenge_event')
