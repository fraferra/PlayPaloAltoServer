...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'play_couponhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon', to=orm['play.Coupon'])),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='player', to=orm['play.Player'])),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shop', to=orm['play.Shop'])),
        ))
    ...
    models = {
        ...
        u'play.couponhistory': {
            ...
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coupon'", 'to': u"orm['play.Coupon']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player'", 'to': u"orm['play.Player']"}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shop'", 'to': u"orm['play.Shop']"})
        },
        u'play.event': {
