...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.picture_url'
        db.alter_column(u'play_player', 'picture_url', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Player.picture_url'
        db.alter_column(u'play_player', 'picture_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
