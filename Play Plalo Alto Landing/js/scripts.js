...
$(document).ready(function() {
	...
	$('.registration #signup').hide();
});


//iphone carousel animation
$(window).load(function () {
	$('.heade').addClass("animated fadeIn");
	$('.heade .logo').addClass("animated tada")
